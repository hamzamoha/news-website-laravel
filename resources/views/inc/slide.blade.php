    ...
    <div class="max-w-screen-xl mx-auto py-5 px-2">
        <div class="grid md:grid-cols-2 h-[608px] md:h-[500px] gap-1">
            <div class="relative group h-[200px] md:h-[500px]">
                ...
                <div class="absolute inset-0 w-full h-full bg-gradient-to-t to-100% from-[rgba(0,0,0,.7)] to-transparent group-hover:opacity-80 transition-all duration-500">
                </div>
                <a href="#" class="flex flex-col justify-end p-3 absolute transition-all duration-500 hover:pb-6 inset-0 w-full h-full">
                    <p class="py-1 text-white">Oct 21, 2023</p>
                    <h3 class="text-4xl font-medium text-white py-1">From the River to the Sea</h3>
            ...
            <div class="h-[404px] md:h-auto">
                <div class="grid grid-rows-2 grid-flow-col h-full gap-1">
                    <div class="relative group">
                        ...
                        <a href="#" class="flex flex-col justify-end p-3 absolute transition-all duration-500 hover:pb-6 md:hover:pb-3 group inset-0 w-full h-full">
                            <p class="py-1 text-white">Oct 21, 2023</p>
                            <h3 class="text-4xl md:text-2xl font-medium text-white py-1">From the River to the Sea</h3>
                    ...
                    <div class="grid grid-cols-2 h-[200px] md:h-auto gap-1">
                        <div class="relative group">
                            ...
                            <a href="#" class="flex flex-col justify-end p-3 absolute transition-all duration-500 group inset-0 w-full h-full">
                                <p class="py-1 text-white">Oct 21, 2023</p>
                                <h3 class="text-2xl font-medium text-white py-1">From the River to the Sea</h3>
